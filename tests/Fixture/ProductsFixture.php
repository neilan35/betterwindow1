...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'products_ibfk_1' => ['type' => 'foreign', 'columns' => ['quote_id'], 'references' => ['quotes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_2' => ['type' => 'foreign', 'columns' => ['colour_id'], 'references' => ['colours', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_3' => ['type' => 'foreign', 'columns' => ['balrating_id'], 'references' => ['balratings', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_4' => ['type' => 'foreign', 'columns' => ['itemtype_id'], 'references' => ['itemtypes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_5' => ['type' => 'foreign', 'columns' => ['design_id'], 'references' => ['designs', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_6' => ['type' => 'foreign', 'columns' => ['reveal_id'], 'references' => ['reveals', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_7' => ['type' => 'foreign', 'columns' => ['flyscreenmesh_id'], 'references' => ['flyscreenmeshes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_ibfk_8' => ['type' => 'foreign', 'columns' => ['glazing_id'], 'references' => ['glazings', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
