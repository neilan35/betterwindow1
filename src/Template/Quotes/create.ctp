    ...
    <fieldset>
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Item Type*:</label>
                <div class="input-group col-sm-5">
                <?php echo $this->Form->input('quoteproducts.itemtype_id', ['options' => $itemtypes,
                'empty' => '(Please choose one)',
                'class'=>'form-control',
                'id'=>'itemtype-id',
                'label'=>false ]);?>
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Height*:</label>
                ...
                <?php echo $this->Form->input('quoteproducts.height', ['placeholder' => '100mm-200mm','id'=>"amount",
                'class'=> 'form-control',
                'type' => 'text',
                'label'=> false]);?>
                </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Reveal*:</label>
                <div class="input-group col-sm-5">
                <?php echo $this->Form->input('quoteproducts.reveal', ['type'=>'checkbox']);?>
                </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Flyscreentype*:</label>
                <div class="input-group col-sm-5">
                    <?php echo $this->Form->input('quoteproducts.flyscreentype',['type'=>'checkbox','yes']);?>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Flyscreentype*:</label>
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="first_name">Composition*:</label>
                <div class="input-group col-sm-5">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-4">
                 <?php echo $this->Html->image('uploads/designs/'.'Fixed1.JPG', ['alt' => 'CakePHP','class' => 'img-thumbnail img-responsive']); ?>
        </div>
